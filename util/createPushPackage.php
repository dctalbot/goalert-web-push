...
$certificate_path = "GoAlert.p12";     // Change this to the path where your certificate is located
$certificate_password = "<INSERT PASSWORD HERE>"; // Change this to the certificate's import password
